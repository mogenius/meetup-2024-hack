...
echo ""
echo ""
echo "      ⚠️     this is no fairytale scenario. this is what many small/medium sized companies are facing."
echo "      ⚠️     if you feel overconfident with your super sophisticated, hyper secure setup I promise you:" 
echo "      ⚠️     you already messed it up big times in at least 10 instances. but you do not know it yet 🤣"
read -p ""
echo ""
echo ""
echo ""
